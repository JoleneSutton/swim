...
**SWIM** is described in **A framework to map fishing activity from incomplete data** (DOI: 10.1093/icesjms/fsag070), which was recently accepted to *ICES Journal of Marine Science*.
